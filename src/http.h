...
#ifndef CPPhttp_http_H
#define CPPhttp_http_H

#define CPPhttp_VERSION "0.18.0"

/*
 * Configuration
 */

#ifndef CPPhttp_KEEPALIVE_TIMEOUT_SECOND
#define CPPhttp_KEEPALIVE_TIMEOUT_SECOND 5
#endif

#ifndef CPPhttp_KEEPALIVE_MAX_COUNT
#define CPPhttp_KEEPALIVE_MAX_COUNT 100
#endif

#ifndef CPPhttp_CONNECTION_TIMEOUT_SECOND
#define CPPhttp_CONNECTION_TIMEOUT_SECOND 300
#endif

#ifndef CPPhttp_CONNECTION_TIMEOUT_USECOND
#define CPPhttp_CONNECTION_TIMEOUT_USECOND 0
#endif

#ifndef CPPhttp_SERVER_READ_TIMEOUT_SECOND
#define CPPhttp_SERVER_READ_TIMEOUT_SECOND 5
#endif

#ifndef CPPhttp_SERVER_READ_TIMEOUT_USECOND
#define CPPhttp_SERVER_READ_TIMEOUT_USECOND 0
#endif

#ifndef CPPhttp_SERVER_WRITE_TIMEOUT_SECOND
#define CPPhttp_SERVER_WRITE_TIMEOUT_SECOND 5
#endif

#ifndef CPPhttp_SERVER_WRITE_TIMEOUT_USECOND
#define CPPhttp_SERVER_WRITE_TIMEOUT_USECOND 0
#endif

#ifndef CPPhttp_CLIENT_READ_TIMEOUT_SECOND
#define CPPhttp_CLIENT_READ_TIMEOUT_SECOND 300
#endif

#ifndef CPPhttp_CLIENT_READ_TIMEOUT_USECOND
#define CPPhttp_CLIENT_READ_TIMEOUT_USECOND 0
#endif

#ifndef CPPhttp_CLIENT_WRITE_TIMEOUT_SECOND
#define CPPhttp_CLIENT_WRITE_TIMEOUT_SECOND 5
#endif

#ifndef CPPhttp_CLIENT_WRITE_TIMEOUT_USECOND
#define CPPhttp_CLIENT_WRITE_TIMEOUT_USECOND 0
#endif

#ifndef CPPhttp_IDLE_INTERVAL_SECOND
#define CPPhttp_IDLE_INTERVAL_SECOND 0
#endif

#ifndef CPPhttp_IDLE_INTERVAL_USECOND
#ifdef _WIN32
#define CPPhttp_IDLE_INTERVAL_USECOND 10000
#else
#define CPPhttp_IDLE_INTERVAL_USECOND 0
#endif
#endif

#ifndef CPPhttp_REQUEST_URI_MAX_LENGTH
#define CPPhttp_REQUEST_URI_MAX_LENGTH 8192
#endif

#ifndef CPPhttp_HEADER_MAX_LENGTH
#define CPPhttp_HEADER_MAX_LENGTH 8192
#endif

#ifndef CPPhttp_REDIRECT_MAX_COUNT
#define CPPhttp_REDIRECT_MAX_COUNT 20
#endif

#ifndef CPPhttp_MULTIPART_FORM_DATA_FILE_MAX_COUNT
#define CPPhttp_MULTIPART_FORM_DATA_FILE_MAX_COUNT 1024
#endif

#ifndef CPPhttp_PAYLOAD_MAX_LENGTH
#define CPPhttp_PAYLOAD_MAX_LENGTH ((std::numeric_limits<size_t>::max)())
#endif

#ifndef CPPhttp_FORM_URL_ENCODED_PAYLOAD_MAX_LENGTH
#define CPPhttp_FORM_URL_ENCODED_PAYLOAD_MAX_LENGTH 8192
#endif

#ifndef CPPhttp_RANGE_MAX_COUNT
#define CPPhttp_RANGE_MAX_COUNT 1024
#endif

#ifndef CPPhttp_TCP_NODELAY
#define CPPhttp_TCP_NODELAY false
#endif

#ifndef CPPhttp_IPV6_V6ONLY
#define CPPhttp_IPV6_V6ONLY false
#endif

#ifndef CPPhttp_RECV_BUFSIZ
#define CPPhttp_RECV_BUFSIZ size_t(16384u)
#endif

#ifndef CPPhttp_COMPRESSION_BUFSIZ
#define CPPhttp_COMPRESSION_BUFSIZ size_t(16384u)
#endif

#ifndef CPPhttp_THREAD_POOL_COUNT
#define CPPhttp_THREAD_POOL_COUNT                                           \
  ((std::max)(8u, std::thread::hardware_concurrency() > 0                      \
                      ? std::thread::hardware_concurrency() - 1                \
                      : 0))
#endif

#ifndef CPPhttp_RECV_FLAGS
#define CPPhttp_RECV_FLAGS 0
#endif

#ifndef CPPhttp_SEND_FLAGS
#define CPPhttp_SEND_FLAGS 0
#endif

#ifndef CPPhttp_LISTEN_BACKLOG
#define CPPhttp_LISTEN_BACKLOG 5
#endif
...
#endif
#elif defined(CPPhttp_USE_CERTS_FROM_MACOSX_KEYCHAIN) && defined(__APPLE__)
...
#ifdef CPPhttp_ZLIB_SUPPORT
#include <zlib.h>
#endif

#ifdef CPPhttp_BROTLI_SUPPORT
...
struct Request {
  ...
  // private members...
  size_t redirect_count_ = CPPhttp_REDIRECT_MAX_COUNT;
...
#if defined(CPPhttp_OPENSSL_SUPPORT) && !defined(OPENSSL_IS_BORINGSSL) &&   \
...
protected:
  ...
  size_t keep_alive_max_count_ = CPPhttp_KEEPALIVE_MAX_COUNT;
  time_t keep_alive_timeout_sec_ = CPPhttp_KEEPALIVE_TIMEOUT_SECOND;
  time_t read_timeout_sec_ = CPPhttp_SERVER_READ_TIMEOUT_SECOND;
  time_t read_timeout_usec_ = CPPhttp_SERVER_READ_TIMEOUT_USECOND;
  time_t write_timeout_sec_ = CPPhttp_SERVER_WRITE_TIMEOUT_SECOND;
  time_t write_timeout_usec_ = CPPhttp_SERVER_WRITE_TIMEOUT_USECOND;
  time_t idle_interval_sec_ = CPPhttp_IDLE_INTERVAL_SECOND;
  time_t idle_interval_usec_ = CPPhttp_IDLE_INTERVAL_USECOND;
  size_t payload_max_length_ = CPPhttp_PAYLOAD_MAX_LENGTH;
...
private:
  ...
  bool tcp_nodelay_ = CPPhttp_TCP_NODELAY;
  bool ipv6_v6only_ = CPPhttp_IPV6_V6ONLY;
...
protected:
  ...
  time_t connection_timeout_sec_ = CPPhttp_CONNECTION_TIMEOUT_SECOND;
  time_t connection_timeout_usec_ = CPPhttp_CONNECTION_TIMEOUT_USECOND;
  time_t read_timeout_sec_ = CPPhttp_CLIENT_READ_TIMEOUT_SECOND;
  time_t read_timeout_usec_ = CPPhttp_CLIENT_READ_TIMEOUT_USECOND;
  time_t write_timeout_sec_ = CPPhttp_CLIENT_WRITE_TIMEOUT_SECOND;
  time_t write_timeout_usec_ = CPPhttp_CLIENT_WRITE_TIMEOUT_USECOND;
...
#ifndef CPPhttp_ALLOW_LF_AS_LINE_TERMINATOR
  char prev_byte = 0;
#endif
...
#ifdef CPPhttp_ALLOW_LF_AS_LINE_TERMINATOR
    if (byte == '\n') { break; }
#else
    if (prev_byte == '\r' && byte == '\n') { break; }
    prev_byte = byte;
...
inline bool mmap::open(const char *path) {
  ...
  // See:
  // https://github.com/yhirose/cpp-http/issues/1903#issuecomment-2316520721
...
inline bool gzip_compressor::compress(const char *data, size_t data_length,
  ...
  do {
    ...
    std::array<char, CPPhttp_COMPRESSION_BUFSIZ> buff{};
    do {
...
inline bool brotli_compressor::compress(const char *data, size_t data_length,
                                        bool last, Callback callback) {
  std::array<uint8_t, CPPhttp_COMPRESSION_BUFSIZ> buff{};
...
inline bool read_headers(Stream &strm, Headers &headers) {
  ...
  for (;;) {
    ...
    if (line_reader.size() > CPPhttp_HEADER_MAX_LENGTH) { return false; }
...
inline bool read_content_with_length(Stream &strm, uint64_t len,
  ...
  char buf[CPPhttp_RECV_BUFSIZ];

  uint64_t r = 0;
  while (r < len) {
    auto read_len = static_cast<size_t>(len - r);
    auto n = strm.read(buf, (std::min)(read_len, CPPhttp_RECV_BUFSIZ));
    if (n <= 0) { return false; }
...
inline bool read_content_without_length(Stream &strm,
  ...
  uint64_t r = 0;
  for (;;) {
    auto n = strm.read(buf, CPPhttp_RECV_BUFSIZ);
    if (n <= 0) { return true; }
  ...
  bool parse(const char *buf, size_t n, const ContentReceiver &content_callback,
    ...
    while (buf_size() > 0) {
      ...
      case 2: { // Headers
        ...
        if (pos > CPPhttp_HEADER_MAX_LENGTH) { return false; }
        while (pos < buf_size()) {
          // Empty line
          if (pos == 0) {
...
inline std::string make_multipart_data_boundary() {
  return "--cpp-http-multipart-data-" + detail::random_string(16);
}
...
inline bool range_error(Request &req, Response &res) {
  if (!req.ranges.empty() && 200 <= res.status && res.status < 300) {
    ...
    // Too many ranges
    if (req.ranges.size() > CPPhttp_RANGE_MAX_COUNT) { return true; }
...
inline ssize_t SocketStream::read(char *ptr, size_t size) {
  ...
  if (size < read_buff_size_) {
    ...
    return read_socket(sock_, ptr, size, CPPhttp_RECV_FLAGS);
  }
}
...
inline ssize_t SocketStream::write(const char *ptr, size_t size) {
  ...
  return send_socket(sock_, ptr, size, CPPhttp_SEND_FLAGS);
}
...
inline Server::Server()
    : new_task_queue(
          [] { return new ThreadPool(CPPhttp_THREAD_POOL_COUNT); }) {
#ifndef _WIN32
...
inline bool Server::read_content(Stream &strm, Request &req, Response &res) {
  ...
  if (read_content_core(
          ...
          [&](const MultipartFormData &file) {
            if (file_count++ == CPPhttp_MULTIPART_FORM_DATA_FILE_MAX_COUNT) {
              return false;
            }
    ...
    if (!content_type.find("application/x-www-form-urlencoded")) {
      if (req.body.size() > CPPhttp_FORM_URL_ENCODED_PAYLOAD_MAX_LENGTH) {
...
Server::create_server_socket(const std::string &host, int port,
  ...
  return detail::create_socket(
      ...
      [](socket_t sock, struct addrinfo &ai, bool & /*quit*/) -> bool {
        ...
        if (::listen(sock, CPPhttp_LISTEN_BACKLOG)) { return false; }
        return true;
      });
}
...
Server::process_request(Stream &strm, const std::string &remote_addr,
  ...
  if (line_reader.size() > CPPhttp_REQUEST_URI_MAX_LENGTH) {
    Headers dummy;
    detail::read_headers(strm, dummy);
...
#ifndef CPPhttp_NO_DEFAULT_USER_AGENT
  if (!req.has_header("User-Agent")) {
    auto agent = std::string("cpp-http/") + CPPhttp_VERSION;
...
#if defined(_WIN32) && defined(CPPhttp_USE_POLL)
#undef poll
#endif

#endif // CPPhttp_http_H