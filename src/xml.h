...
/*
	gcc:
        g++ -Wall -Dxml_DEBUG xml.cpp xmltest.cpp -o gccxmltest.exe

    Formatting, Artistic Style:
        AStyle.exe --style=1tbs --indent-switches --break-closing-brackets --indent-preprocessor xml.cpp xml.h
*/
...
#ifdef _MSC_VER
#   ifdef xml_EXPORT
#       define xml_LIB __declspec(dllexport)
#   elif defined(xml_IMPORT)
#       define xml_LIB __declspec(dllimport)
#   else
#       define xml_LIB
#   endif
#elif __GNUC__ >= 4
#   define xml_LIB __attribute__((visibility("default")))
#else
#   define xml_LIB
#endif
...
static const int xml_MAX_ELEMENT_DEPTH = 500;
...
/*
    ...
    Isn't clear why xml_LIB is needed; but seems to fix #719
*/
class xml_LIB StrPair
{
public:
    enum Mode {
...
*/
class xml_LIB XMLText : public XMLNode
{
    friend class XMLDocument;
public:
...
/** An XML Comment. */
class xml_LIB XMLComment : public XMLNode
{
    friend class XMLDocument;
public:
...
*/
class xml_LIB XMLDeclaration : public XMLNode
{
    friend class XMLDocument;
public:
...
*/
class xml_LIB XMLUnknown : public XMLNode
{
    friend class XMLDocument;
public:
...
*/
class xml_LIB XMLElement : public XMLNode
{
    friend class XMLDocument;
public:
...
*/
class xml_LIB XMLDocument : public XMLNode
{
    friend class XMLElement;
...
/**
	...
	@endverbatim
*/
class xml_LIB XMLPrinter : public XMLVisitor
{
public:
